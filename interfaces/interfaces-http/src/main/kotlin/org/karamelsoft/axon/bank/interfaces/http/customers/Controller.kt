...
import org.karamelsoft.axon.bank.services.customers.api.CorrectCustomerAddress
import org.karamelsoft.axon.bank.services.customers.api.CorrectCustomerDetails
import org.karamelsoft.axon.bank.services.customers.api.CustomerId
import org.karamelsoft.axon.bank.services.customers.api.RegisterUniqueCustomer
...
class CustomerController(
    ...
    fun getCustomerDashboard(@PathVariable("customerId") customerId: String): Mono<CustomerDashboardResponse> {
        return queryGateway.query(
            GetCustomerDashboard(org.karamelsoft.axon.bank.views.customer.dashboard.api.CustomerId.from(customerId)),
