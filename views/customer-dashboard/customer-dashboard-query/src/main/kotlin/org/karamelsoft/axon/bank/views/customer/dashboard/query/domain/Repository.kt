...
import org.karamelsoft.axon.bank.services.cards.api.CardOwner
...
fun CustomerDashboardRepository.findByCustomer(customerId: org.karamelsoft.axon.bank.views.customer.dashboard.api.CustomerId) = this.findByCustomerId(customerId.value.toString())
